            ...
            <div className="rounded-[32px] overflow-hidden relative shadow-deep">
                ...
                <div className="absolute inset-0 bg-navy/80 flex items-center px-10">
                    <div className="max-w-xl">
                        ...
                        <p className="text-base text-white/70 mb-6 max-w-md">Earn premium returns by listing your luxury property with ORA. We provide standard maintenance and management for your assets.</p>
                        <a

                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-16 mb-20">
                        ...
                        <Link href="/" className="flex items-center gap-4 mb-8 group">
                            <div className="w-12 h-12 rounded-full overflow-hidden border border-white/10 p-0.5 group-hover:border-saffron transition-all duration-500">
                                <div className="w-full h-full rounded-full overflow-hidden">
                                    <img src="/DARK VORA LOGO WITH BG.svg" alt="VORA" className="w-full h-full object-cover" />
                                </div>
                            </div>
                    ...
                    {columns.map((col) => (
                        <div key={col.title} className="lg:col-span-1">
                            <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-saffron mb-10">{col.title}</h4>
                    ...
                    <div className="lg:col-span-1">
                        <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-saffron mb-10">Enquiry</h4>
                        <div className="flex flex-col gap-8">
                            <div>
                                ...
                                <a href="tel:+919384870119" className="text-xl font-medium tracking-tight hover:text-saffron transition-all duration-500 flex flex-col mb-4">
                                    +91 93848 70119
                                </a>

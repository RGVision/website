...
export default function TermsPage() {
  const sections = [
    ...
    },
    {
      ...
      content: "ORA shall not be held responsible for any disruptions caused due to events beyond control, including natural disasters, weather conditions, government restrictions, or utility failures."
    },
    {
      title: "16. Personal Belongings",
      content: "Guests are responsible for their personal belongings. ORA is not liable for any loss, theft, or damage."
    },
    {
      title: "17. Management Rights",
      content: "ORA reserves the right to refuse entry, cancel bookings, or evict guests in case of rule violations. No refund will be provided in such cases."
    },
    {
    ...
    <main className="min-h-screen bg-white pt-32 pb-24">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="text-center mb-20 animate-fadeInUp">
          <h4 className="text-saffron font-black uppercase tracking-[0.3em] text-[10px] mb-4">ORA</h4>
          ...
          <p className="text-navy/60 text-sm max-w-2xl mx-auto leading-relaxed">
            Welcome to ORA. By confirming your booking and staying at our property, you agree to comply with the following terms and conditions.
          </p>
        ...
        <div className="mt-24 pt-12 border-t border-navy/5 text-center animate-fadeInUp" style={{ animationDelay: '0.4s' }}>
          <p className="text-navy font-display text-xl mb-2">ORA STAYS</p>

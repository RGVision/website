...
export default function VillaDetailPage() {
    ...
    if (!villa) {
        return (
            <div className="min-h-[60vh] flex items-center justify-center text-center px-6">
                <div>
                    <h1 className="font-display text-[length:var(--font-size-h1)] font-bold mb-4">Villa Not Found</h1>
                    <p className="text-muted-foreground mb-8">The villa you&apos;re looking for doesn&apos;t exist.</p>
                    <Button asChild className="bg-gold-gradient text-primary-foreground border-0 rounded-full px-6">
    ...
    const similarVillas = villas.filter((v) => v.slug !== villa.slug).slice(0, 3);
